    ...
    <div className="min-h-screen bg-white flex flex-col items-center">
      ...
      <nav className="border-b w-full">
        <div className="container mx-auto flex flex-col sm:flex-row justify-center sm:justify-between items-center py-4 px-4">
          <div className="text-2xl font-bold text-emerald-700 mb-4 sm:mb-0">
            MediMate
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between py-16 gap-8">
            <div className="space-y-6 max-w-xl text-center lg:text-left">
              ...
              <p className="text-emerald-50 text-lg">
                We provide high quality healthcare with modern equipment. You
                can easily reach us 24/7 at the numbers below.
              </p>
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                >
                  <Button
                    variant="outline"
                    className="bg-transparent cursor-pointer border-white text-white hover:bg-white hover:text-emerald-700"
                  >
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12 max-w-6xl mx-auto">
            <div className="space-y-6 text-center lg:text-left">
              ...
              <p className="text-gray-600">
                Our medical center provides comprehensive care with a team of
                experienced healthcare professionals. We&apos;re committed to
                delivering the highest quality medical services to our
                community.
              </p>
            ...
            {[
              ...
              >
                ...
                <p className="text-gray-600 mb-4">
                  Brief description of the blog post. Click to read more about{" "}
                  {title}.
                </p>
                <Link
                  href="#"
